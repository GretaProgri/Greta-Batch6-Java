 ...
 * ‘?’ mark Access Modifier: public Non-Access Modifier: static Return Type:
 * char Method Name: getCharacter Parameter1: String strOne Parameter2: Int
 * indexNum Test Data: getCharacter (“java training”, 2) ----- v getCharacter
 * (“java training”, 5) ----- t getCharacter (“java training”, 8) ----- i
